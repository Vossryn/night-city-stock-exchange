...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-CpWNgaAi.mjs');
...
const appCss = "/assets/app-Cco-0rvH.css";
const initialState = {
  theme: "system",
  setTheme: () => null
};
...
function RootComponent() {
  return /* @__PURE__ */ jsx(ThemeProvider, { defaultTheme: "system", storageKey: "vite-ui-theme", children: /* @__PURE__ */ jsx(RootDocument, { children: /* @__PURE__ */ jsx(Outlet, {}) }) });
}
...
const $$splitComponentImporter = () => import('./index-BS3bLI3Q.mjs');
...
export { serverEntry as default, useTheme as u };
