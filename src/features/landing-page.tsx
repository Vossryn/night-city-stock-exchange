    ...
    <div className="flex flex-col gap-12 max-w-5xl mx-auto">
      ...
      <section className="flex flex-col items-center text-center gap-6 py-12 md:py-20 border-b border-cyan-900/30">
        ...
        <p className="text-lg md:text-xl text-cyan-400/80 max-w-2xl mx-auto leading-relaxed">
          ...
          Trade the biggest corps in Night City. Make your fortune or die
          trying.
        </p>
      ...
      <section className="grid md:grid-cols-3 gap-6">
        <div className="p-6 border border-cyan-900/30 bg-black/40 backdrop-blur-sm hover:border-cyan-500/50 transition-colors group">
          ...
          <p className="text-cyan-400/60 text-sm">
            Live market updates. Execute buy and sell orders instantly. Don't
        ...
        <div className="p-6 border border-cyan-900/30 bg-black/40 backdrop-blur-sm hover:border-cyan-500/50 transition-colors group">
          ...
          <p className="text-cyan-400/60 text-sm">
            Access detailed dossiers on Arasaka, Militech, and more. Knowledge
            is power. Power is eddies.
          </p>
        </div>
        ...
        <div className="p-6 border border-cyan-900/30 bg-black/40 backdrop-blur-sm hover:border-cyan-500/50 transition-colors group">
          ...
          <p className="text-cyan-400/60 text-sm">
            Track your net worth. Diversify your holdings. Become the richest
            edgerunner in Night City.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-6">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {featuredCompanies.map((company) => (
            <div
              key={company.name}
              className="flex items-center gap-4 p-4 border border-cyan-900/20 bg-cyan-950/5 hover:bg-cyan-900/10 transition-colors"
            >
              <div className="w-12 h-12 bg-black border border-cyan-900/50 p-1 flex items-center justify-center overflow-hidden">
                <img
                  src={company.image}
                  alt={company.name}
                  className="w-full h-full object-contain opacity-80 grayscale hover:grayscale-0 transition-all"
                />
              </div>
              <div>
