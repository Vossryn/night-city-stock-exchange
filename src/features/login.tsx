      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {DEMO_USERS.map((user) => (
            <Card
              key={user.id}
              className="p-6 transition-all hover:scale-105 hover:shadow-[0_0_20px_rgba(0,255,255,0.3)] border-gray-700"
            >
              <div className="flex flex-col items-center text-center space-y-3">
                ...
                <Button
                  className="w-full mt-2 bg-neon-blue text-black hover:bg-neon-blue/80 font-bold tracking-wider"
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          ...
          <p className="mt-2 text-xs">
            Demo mode active. Select a character to access the trading terminal.
          </p>
        </div>
      </div>
    </div>
